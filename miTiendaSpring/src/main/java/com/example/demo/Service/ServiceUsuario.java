...
public class ServiceUsuario {
	...
	public ModelUsuario findUser(ModelUsuario usuarioDTO) {
		return listaUsuarios.stream().filter(
				element -> usuarioDTO.getNombre().equals(element.getNombre()) &&
					 	   usuarioDTO.getPassword().equals(element.getPassword()))
				.findAny().orElse(null);
	}
	...
	public void init() {
		listaUsuarios.addAll(Arrays.asList(
				new ModelUsuario(1, "Admin", "1234", "admin@gmail.com", "666666666", "secret"),
